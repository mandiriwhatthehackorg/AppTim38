...
import kotlinx.android.synthetic.main.activity_verification_selfie.*
import kotlinx.android.synthetic.main.default_toolbar.view.*
import java.io.IOException


class VerificationSelfieActivity : BaseActivity(), SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    override fun onSetupLayout(savedInstanceState: Bundle?) {
        setContentView(R.layout.activity_verification_selfie)
    ...
    override fun onViewReady(savedInstanceState: Bundle?) {
        ...
        btn_add_life_plan.setOnClickListener {
            startActivity(Intent(this@VerificationSelfieActivity, VerificationSignatureActivity::class.java))
        }
    }
    ...
    private fun showSettingsDialog() {
        val builder = AlertDialog.Builder(this@VerificationSelfieActivity)
